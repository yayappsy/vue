  ...
  <div class="company_employ_pending">
    ...
    <div class="employ_pending_title">
      ...
      <div class="pending_title_middle">
        <h3><span class="redText">{{jobInResumeDtos.length}}</span>封待处理简历</h3>
      </div>
          ...
          <li class="people_inner" v-for="list in jobInResumeDtos">
            ...
            <div class="people_information">
              ...
              <div class="people_base_information">
                ...
                <div class="options">
                  <a @click="handResume(list.id,4)">待定</a>
                  <a @click="handResume(list.id,2)">不合适</a>
                </div>
              </div>
            </div>
          </li>
    ...
    <div class="sxs--modal" v-if="addressSelection2"  @click="addressSelection2=false;">
      ...
      <div class="sxs--modal--container sxs--modal--shown" style="height: 650px; margin-top: -320px;width: 700px">
        <div class="sxs--modal--content" style="letter-spacing: 1px; max-height: 650px;width: 700px" @click.stop="">
          <div class="in_top"><span class="top-name">面试邀请</span><span class="in_exit" @click="addressSelection2=false">我要自行通知</span></div>
          <div class="in_content">
            <div class="in_first">
              ...
              <div class="in_item" style="height: 50px"><span class="in_l"><span class="star">面试时间</span></span>
                ...
                <date-picker field="myDate2" placeholder="请选择出生年月日" v-model="searchResume.arrivalDate" format="yyyy-mm-dd"  forward="true" style="width: 120px;padding-top: 5px;padding-left: 20px"></date-picker>
              </div>
            </div>
            <div class="in_second">
            ...
            <div class="in_last">
              ...
              <div class="in_send"><span class="in_send_btn" @click="Send_Email()">邀请面试</span></div>
            </div>
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      mainshiyaoqing:function (list) {
        this.emain.id=list.id;
        // this.emain.email=list.email;
      ...
      getCompanyInfo:function () {
        this.postData("/api/companyDetail/companyInfo",{companyId:this.searchResume.companyId},{}).then((res) => {
          if(res.data.code==0){
            this.emain.c_name=res.data.data.name;
            this.emain.recipient=this.emain.c_name+":"+this.emain.jobName;
      ...
      Send_Email:function(){
        ...
        let data={
          "email": this.emain.Email,
          "fromAlias": "面试通知",
          "htmlBody": '<p>公司名称:'+this.emain.c_name+'</p>'+
          '<p>应聘职位:'+this.emain.jobName+'</p>'+
        ...
        this.postData2("/api/jobInManager/sendEmail",data).then((res) => {
          ...
          if(res.data.code==0){
            ...
            this.handResume(this.emain.id,1);
          }
        })
      },
      //保存模板
      ...
      initdata:function () {
        ...
        console.log(JSON.stringify(this.searchResume));
      ...
      Q_handResume:function (num) {
        ...
        this.jRData.forEach(function (element) {
          _this.handResume(element.id,num)
        })
      },
